package com.frame.saeasyandroids.imageloader;
...
import com.frame.saeasyandroids.http.HttpHelper;
import com.frame.saeasyandroids.http.HttpHelper.HttpResult;
import com.frame.saeasyandroids.util.DrawableUtils;
import com.frame.saeasyandroids.util.FileUtils;
import com.frame.saeasyandroids.util.Logger;
import com.frame.saeasyandroids.util.StringUtils;
import com.frame.saeasyandroids.util.SystemUtils;
import com.frame.saeasyandroids.util.ThreadManager;
import com.frame.saeasyandroids.util.ThreadManager.ThreadPoolProxy;
import com.frame.saeasyandroids.util.UIUtils;
...
public class ImageLoader {
	...
	public static void load(ImageView view, String url) {
		...
		if (drawable != null) {
			...
			view.setImageResource(R.drawable.ic_launcher);// 如果没加载到，设置默认图片，并异步加载
			asyncLoad(view, url);
		}
	}
